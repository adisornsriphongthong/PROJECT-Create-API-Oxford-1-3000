# PROJECT-Create-API-Oxford-1-3000-FetchData-GoogleSheet-By-GoogleCloud
...
- [npm install axios@^1.6.3 cors@^2.8.5 express@^4.18.2 mongodb@^6.3.0 nodemon@^3.0.2 react@^18.2.0 react-dom@^18.2.0 react-google-charts@^4.0.1]()
  ...
  <a href="" target="_blank" rel="noreferrer"> <img src="https://railway.app/brand/logo-light.png" alt="bootstrap" width="45" height="45" /></a>
